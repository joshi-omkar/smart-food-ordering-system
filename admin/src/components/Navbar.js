    ...
    <section className="navbar">
      <div className="left-container">
        ...
        <div className="navlink-contanier">
          ...
          <Link to='/orderHistory'><span className="navlink">Order History</span></Link>
        </div>
      </div>
      <div className="icon-container">
        <span className="icon"><img src={Search} alt="Search" /></span>
        <span className="icon"><img src={Notification} alt="Notification" /></span>
